...
angular.module('proyecto').service('$menuItemsProyecto', [
    function () {
        ...
        this.prepareSidebarMenu = function () {
            ...
            certificacion.addItem('Proyectos', 'proyecto.app.certificacionAmbiental.proyecto');

            //administracion.addItem('Administracion', 'proyecto.app.administracion');
